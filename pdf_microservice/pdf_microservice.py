...
class PDFRequest(BaseModel):
    ...
    atividades: List[str]  # nomes dos arquivos (ex: "AMA01")
...
async def gerar_pdf(req: PDFRequest):
    try:
        ...
        pagina.insert_text(fitz.Point(72, 120), texto, fontsize=12, fontname="helv", color=(0, 0, 0))
        y = 180
